...
/**
 * @file
 * Bedrock implementation to display a block.
 *
 * The block template in Bedrock is a little different to most other themes.
 * Instead of hard coding its markup bedrock generates most of it in
 * bedrock_process_block(), conditionally printing outer and inner wrappers.
 *
 ...
 * @see bedrock_preprocess_block()
 * @see bedrock_process_block()
 */
?>
