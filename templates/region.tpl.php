...
/**
 * @file
 * Bedrock region.tpl.php
 *
 * The region template in Bedrock is a little different to most other themes.
 ...
 * @see bedrock_preprocess_region()
 * @see bedrock_process_region()
 */
if ($content) {
