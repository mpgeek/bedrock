...
http_path = "/sites/all/themes/bedrock"
css_dir = "css"
sass_dir = "sass"
images_dir = "images"
...
#themes can be installed in multiple locations, we shouldn't need to worry about
# the absolute path to the theme from the server root.
relative_assets = true

# To enable debugging comments that display the original location of your
# selectors. Comment:
line_comments = false

# In development, we can turn on the debug_info to use with FireSass or Chrome
# Web Inspector. Uncomment:
# debug = true
